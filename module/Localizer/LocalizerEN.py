...
class LocalizerEN(LocalizerBase):
    ...
    file_checker_translation_full: str = "Translation status check completed, {COUNT} abnormal entries found, accounting for {PERCENT} %, results written to [green]{TARGET}[/] ..."
    ...
    # project_page_source_language_items: str = "Chinese,English,Japanese,Korean,Russian,German,Thai,Indonesian,Vietnamese"
    ...
    # project_page_target_language_items: str = "Chinese,English,Japanese,Korean,Russian,German,Thai,Indonesian,Vietnamese"
